...
//     // Visits API requires: user, property, preferred_time, agent
//     const visitData = {
...
//           <h1 className="text-4xl font-bold text-gradient mb-2">Schedule Property Visit</h1>
...
//                               visitType === type.id ? 'text-primary' : 'text-muted-foreground'
//                             }`} />
...
//                             const isPast = selectedDate?.toDateString() === new Date().toDateString() && timeSlotDate < new Date();
...
//                         Back
//                       </Button>
//                       <Button onClick={() => setStep(4)} className="btn-hero">
//                         Continue to Details
//                       </Button>
//                     </div>
//                   </div>
...
//                         Back
//                       </Button>
//                       <Button onClick={() => setStep(5)} className="btn-hero">
//                         Review Booking
//                       </Button>
//                     </div>
//                   </div>
                            ...
                            <div className="flex-1">
                              ...
                              <div className="flex items-center justify-between">
                                ...
                                <div className="flex space-x-2">
                                  ...
                                  <Button 
                                    size="sm" 
                                    className={selectedAgent === agent.id ? "btn-hero" : "btn-property"}
                                    onClick={() => handleSelectAgent(agent.id)}
                                  >
