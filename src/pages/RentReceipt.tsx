                ...
                <CardContent className="print:p-8">
                  ...
                  <div className="space-y-6 bg-white p-8 border rounded-lg print:border-none print:p-0">
                    ...
                    <div className="text-center border-b pb-4">
                      <h1 className="text-2xl font-bold text-primary">RENT RECEIPT</h1>
                    ...
                    <div className="space-y-4">
                      <div className="bg-muted/50 p-4 rounded-lg">
                        <div className="flex justify-between items-center">
                          ...
                          <span className="text-2xl font-bold text-primary">₹{Number(generatedReceipt.rentAmount).toLocaleString('en-IN')}</span>
                        </div>
                      </div>
