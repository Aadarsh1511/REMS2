      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            {/* Contact Section */}
            <Card className="p-6 mt-8 bg-muted/20 border-primary/20">
              <div className="text-center">
                ...
                <div className="grid md:grid-cols-3 gap-4 text-sm">
                  <div>
                    ...
                    <p className="text-primary">privacy@realestatepro.com</p>
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <p className="text-primary">dpo@realestatepro.com</p>
                  </div>
                </div>
              </div>
            </Card>
