...
import { TrendingUp, TrendingDown, BarChart3, Map, Search, Download, Filter } from "lucide-react";
        ...
        <div className="container mx-auto px-4">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-xl text-muted-foreground mb-8">
              Stay ahead with comprehensive market insights and property price trends across India
            </p>
        ...
        <div className="container mx-auto px-4">
          <Tabs defaultValue="cities" className="w-full">
            <TabsList className="grid grid-cols-4 w-full max-w-2xl mx-auto mb-12">
              <TabsTrigger value="cities">By Cities</TabsTrigger>
                ...
                {cityTrends.map((city, index) => (
                  <Card key={index} className="hover:shadow-lg transition-all duration-300">
                    ...
                    <CardContent>
                      ...
                      <p className="text-xs text-muted-foreground mb-2">per sq ft</p>
                      <div className={`text-sm font-medium ${city.trend === "up" ? "text-green-500" : "text-red-500"}`}>
                ...
                {propertyTypes.map((type, index) => (
                  <Card key={index} className="hover:shadow-lg transition-all duration-300">
                    ...
                    <CardContent>
                      ...
                      <p className="text-xs text-muted-foreground mb-2">average price</p>
                      <div className="text-sm font-medium text-green-500">{type.change}</div>
                    </CardContent>
                  </Card>
                ))}
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {localities.map((locality, index) => (
                  <Card key={index} className="hover:shadow-lg transition-all duration-300">
                    ...
                    <CardContent>
                      <div className="text-2xl font-bold text-primary">{locality.price}</div>
                      <div className="text-sm font-medium text-green-500 mt-2">{locality.change}</div>
                    </CardContent>
                  </Card>
                ))}
              </div>
                ...
                <Card>
                  ...
                  <CardContent className="space-y-4">
                    <div className="p-4 bg-green-50 rounded-lg border border-green-200">
                      <h4 className="font-semibold text-green-800">High Growth Areas</h4>
                      <p className="text-sm text-green-600">Powai, Thane, Noida Extension</p>
                    </div>
                    <div className="p-4 bg-blue-50 rounded-lg border border-blue-200">
                      <h4 className="font-semibold text-blue-800">Emerging Markets</h4>
                      <p className="text-sm text-blue-600">Navi Mumbai, Gurgaon Sector 150</p>
                    </div>
                  </CardContent>
                </Card>
              </div>
