                    ...
                    <CardContent>
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        {propertyHighlights.map((highlight, index) => (
                          <div
                            key={index}
                            className="flex items-start gap-4 p-4 bg-gradient-to-r from-primary/5 to-primary/10 rounded-lg"
                          >
                      ...
                      <div className="space-y-6">
                        <div>
                          ...
                          <p className="text-muted-foreground leading-relaxed">
                            ...
                            districts and is home to many Bollywood celebrities.
                            With its tree-lined streets and proximity to the
                      ...
                      <Accordion type="single" collapsible className="w-full">
                        ...
                        <AccordionItem value="item-2">
                          ...
                          <AccordionContent>
                            ...
                            construction-linked plans, possession-linked plans,
                            and down payment plans. Home loan assistance is also
