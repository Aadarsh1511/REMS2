    ...
    <Card className="card-gradient shadow-lg hover:shadow-xl transition-shadow duration-300">
        <CardHeader>
            <div className="flex items-center gap-3">
                ...
                <CardTitle className="text-xl font-bold">Customer Service Data</CardTitle>
            </div>
        </CardHeader>
        ...
        <CardContent className="space-y-4">
            {customerdata && customerdata.length > 0 ? (
                customerdata.map((customer, index) => (
                    ...
                    >
                        <div className="flex justify-between items-start">
                            <p className="font-bold text-base mb-1 pr-2">{customer.full_name}</p>
                            <Badge
                                variant={customer.priority === 'high' || customer.priority === 'urgent' ? 'destructive' : 'outline'}
                                className="capitalize flex-shrink-0"
                            >
                                {customer.priority}
                            </Badge>
                        </div>
                        <p className="text-sm text-muted-foreground truncate mb-3">{customer.subject}</p>
                ...
                <p className="text-center text-muted-foreground py-4">No customer service requests yet.</p>
            )}
        </CardContent>
    </Card>
    // JSX - Customer Service Dialog
    <Dialog open={open} onOpenChange={setOpen}>
        <DialogContent className="sm:max-w-3xl p-6" aria-describedby="customer-dialog-description">
                    ...
                    {customerEditMode ? (
                        ...
                        <div className="space-y-4">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <Select
                                        ...
                                        onValueChange={(value) => setCustomerEdit({ ...customerEdit, priority: value })}
                                    >
                            ...
                            <div className="flex justify-end gap-2 pt-4 border-t">
                                <Button variant="outline" onClick={() => setCustomerEditMode(false)}>
                                    Cancel
                                </Button>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-3">
                                ...
                                <div className="flex items-start gap-3">
                                    ...
                                    <div className="flex flex-col">
                                        <span className="font-medium text-xs text-muted-foreground uppercase tracking-wide">Full Name</span>
                                        <span className="text-sm mt-1">{selectedCustomer.full_name || "N/A"}</span>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-start gap-3">
                                    ...
                                    <div className="flex flex-col">
                                        ...
                                        <span className="text-sm mt-1 break-all">{selectedCustomer.email || "N/A"}</span>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-start gap-3">
                                    ...
                                    <div className="flex flex-col">
                                        <span className="font-medium text-xs text-muted-foreground uppercase tracking-wide">Phone</span>
                                        <span className="text-sm mt-1">{selectedCustomer.phone_number || "N/A"}</span>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-start gap-3">
                                    ...
                                    <div className="flex flex-col">
                                        <span className="font-medium text-xs text-muted-foreground uppercase tracking-wide">Category</span>
                                        <span className="text-sm mt-1">{selectedCustomer.category || "N/A"}</span>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-start gap-3">
                                    ...
                                    <div className="flex flex-col">
                                        <span className="font-medium text-xs text-muted-foreground uppercase tracking-wide">Priority</span>
                                        <span className="text-sm mt-1 capitalize">{selectedCustomer.priority || "N/A"}</span>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-start gap-3">
                                    ...
                                    <div className="flex flex-col">
                                        <span className="font-medium text-xs text-muted-foreground uppercase tracking-wide">Created</span>
                                ...
                                <div className="flex items-start gap-3 md:col-span-2">
                                    ...
                                    <div className="flex flex-col w-full">
                                        <span className="font-medium text-xs text-muted-foreground uppercase tracking-wide">Subject</span>
                                        <span className="text-sm mt-1 break-words">{selectedCustomer.subject || "N/A"}</span>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-start gap-3 md:col-span-2">
                                    ...
                                    <div className="flex flex-col w-full">
                                        <span className="font-medium text-xs text-muted-foreground uppercase tracking-wide">Message</span>
                                        <p className="text-sm mt-1 break-words leading-relaxed">{selectedCustomer.message || "N/A"}</p>
                                    </div>
                                </div>
                            </div>
