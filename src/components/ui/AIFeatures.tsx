  ...
  return (
    <section className="py-24 bg-gray-50 relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute top-60 right-1/3 w-24 h-24 bg-primary-glow/10 rounded-full blur-xl animate-pulse" style={{animationDelay: '1s'}}></div>
      </div>
      
      <div className="container mx-auto px-4  relative z-10">
        <div className="text-center mb-20">
          <div className="inline-block mb-6">
            <span className="bg-gradient-hero bg-clip-text text-blue-600 text-lg font-bold tracking-wider uppercase">Next-Gen Technology</span>
          </div>
          <h2 className="text-5xl md:text-7xl font-bold mb-8 text-foreground leading-tight">
            Powered by
            <span className="block bg-gradient-hero bg-clip-text text-blue-700">
            ...
            >
              ...
              <CardContent className="p-8 text-center relative z-10">
                ...
                <div className="mt-6 opacity-0 group-hover:opacity-100 transition-all duration-300 transform translate-y-2 group-hover:translate-y-0">
                  <button className="text-primary hover:text-primary-glow font-semibold text-sm uppercase tracking-wide transition-colors">
                    Learn More →
                  </button>
                </div>
              </CardContent>
        ...
        <div className="text-center space-y-8">
          <Button size="lg" className="bg-gradient-hero text-white border-blue-500 bg-blue-600 border shadow-glow hover:text-white hover:shadow-elegant transition-all duration-300 px-16 py-8 text-xl rounded-2xl">
